...
if ($backendListener) {
    ...
    if ($backendCommandLine -and $backendCommandLine.Contains('com.salihguneyin.campushub.CampusHubApplication')) {
...
if ($frontendListener) {
    ...
    if ($frontendCommandLine -and $frontendCommandLine.ToLowerInvariant().Contains('campus-hub')) {
